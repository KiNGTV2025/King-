...
class StreamFetcher:
    def __init__(self):
        ...
        # GitHub Actions secrets ile Dropbox erişimi
        self.dropbox_token = os.getenv("DROPBOX_REFRESH_TOKEN")
        self.dropbox_app_key = os.getenv("DROPBOX_APP_KEY")
        self.dropbox_app_secret = os.getenv("DROPBOX_APP_SECRET")
        if not all([self.dropbox_token, self.dropbox_app_key, self.dropbox_app_secret]):
            raise ValueError("Dropbox secrets missing! Add them in GitHub repo secrets.")
